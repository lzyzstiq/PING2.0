...
public class QuoteManager {
    ...
    private static final String EXTERNAL_QUOTE_FILE = "/sdcard/语料库.txt";
    ...
    private static void loadQuotes(Context context) {
        File externalFile = new File(EXTERNAL_QUOTE_FILE);
        if (externalFile.exists()) {
            try (BufferedReader reader = new BufferedReader(
                    new InputStreamReader(new FileInputStream(externalFile), "UTF-8"))) {
                String line;
